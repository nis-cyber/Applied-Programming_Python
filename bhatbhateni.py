    ...
    def initialInformation(self):
        ...
        for i in range(n):
            ...
            for j in range(itemno):
                ...
                print("\n")
                customer_data[i]['items'][j] = {'item_name': itemname, 'item_price': itemprice, 'item_qty': itemqty,
    ...
    def display_bill(self, customer_data):
        for i in range(len(customer_data)):
            ...
            for j in range(len(customer_data[i]['items'])):
                print("{:<20} {:>10} {:>15} {:>15}".format(customer_data[i]['items'][j]['item_name'],
                                                           customer_data[i]['items'][j]['item_price'],
                                                           customer_data[i]['items'][j]['item_qty'],
